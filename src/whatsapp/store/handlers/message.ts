	...
	const set: BaileysEventHandler<"messaging-history.set"> = async ({ messages, isLatest }) => {
		try {
			...
			emitEvent(
				...
				undefined,
				"error",
				`An error occured during messages set: ${typeof e === "object" && e && "message" in e ? (e as any).message : String(e)}`,
			);
		}
	};
				...
				for (const message of messages) {
					try {
						...
						emitEvent(
							...
							undefined,
							"error",
							`An error occured during message upsert: ${typeof e === "object" && e && "message" in e ? (e as any).message : String(e)}`,
						);
					}
				}
				break;
		...
		for (const { update, key } of updates) {
			try {
				...
				emitEvent(
					...
					undefined,
					"error",
					`An error occured during message update: ${typeof e === "object" && e && "message" in e ? (e as any).message : String(e)}`,
				);
			}
		}
	};
	...
	const del: BaileysEventHandler<"messages.delete"> = async (item) => {
		try {
			...
			emitEvent(
				...
				undefined,
				"error",
				`An error occured during message delete: ${typeof e === "object" && e && "message" in e ? (e as any).message : String(e)}`,
			);
		}
	};
		...
		for (const { key, receipt } of updates) {
			try {
				...
				emitEvent(
					...
					undefined,
					"error",
					`An error occured during message receipt update: ${typeof e === "object" && e && "message" in e ? (e as any).message : String(e)}`,
				);
			}
		}
	};
		...
		for (const { key, reaction } of reactions) {
			try {
				...
				emitEvent(
					...
					undefined,
					"error",
					`An error occured during message reaction update: ${typeof e === "object" && e && "message" in e ? (e as any).message : String(e)}`,
				);
			}
		}
	};
