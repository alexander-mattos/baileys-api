	...
	const set: BaileysEventHandler<"messaging-history.set"> = async ({ chats, isLatest }) => {
		try {
			...
			emitEvent(
				...
				undefined,
				"error",
				`An error occured during chats set: ${typeof e === "object" && e && "message" in e ? (e as any).message : String(e)}`,
			);
		}
	};
	...
	const upsert: BaileysEventHandler<"chats.upsert"> = async (chats) => {
		try {
			...
			emitEvent(
				...
				undefined,
				"error",
				`An error occured during chats upsert: ${typeof e === "object" && e && "message" in e ? (e as any).message : String(e)}`,
			);
		}
	};
      ...
      for (const update of updates) {
         try {
            ...
            emitEvent(
               ...
               undefined,
               "error",
			   `An error occurred during chat update: ${typeof e === "object" && e && "message" in e ? (e as any).message : String(e)}`,
            );
	...
	const del: BaileysEventHandler<"chats.delete"> = async (ids) => {
		try {
			...
			emitEvent(
				...
				undefined,
				"error",
				`An error occured during chats delete: ${typeof e === "object" && e && "message" in e ? (e as any).message : String(e)}`,
			);
		}
	};
